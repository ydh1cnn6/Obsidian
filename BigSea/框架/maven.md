---
updateDate: 2026-03-31 16:57:17
title: maven
---
### 远程仓库
1、修改远程仓库地址

mirror：覆盖repository的镜像地址

repository：实际上maven会从此repository对应的mirror对应的地址下载jar包

server：私服的鉴权信息

教程：[https://blog.csdn.net/qq_14947845/article/details/124765578](https://blog.csdn.net/qq_14947845/article/details/124765578)



2、注意：

项目的maven地址要重新配置，在setting-Build-`Build Tools`- `Maven`



3、多个远程仓库

配置profile，不要配置mirror，
